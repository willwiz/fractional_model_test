...
cdef extern from "cpp/optimization/simulation.cpp":
  pass
...
cdef extern from "cpp/optimization/simulation.hpp" namespace "sim":
  ...
  cdef void femoral_he_simulate_scaled(double[] pars, double[] fiber,
    double[] caputo, double Tf, double[] Cmax, double[] args, double[] dt,
    double[] stress, int n)
  ...
  cdef void femoral_ve_simulate_scaled(double[] pars, double[] fiber,
    double[] caputo, double Tf, double[] Cmax, double[] args, double[] dt,
    double[] stress, int n)
